...
#include "GridPlacerEditorMode.generated.h"
 ...
 */
UCLASS()
class UGridPlacerEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_GridPlacerEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;
	static FString PlacementToolName;

	UGridPlacerEditorMode();
	virtual ~UGridPlacerEditorMode();
