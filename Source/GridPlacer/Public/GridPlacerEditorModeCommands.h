 ...
 */
class FGridPlacerEditorModeCommands : public TCommands<FGridPlacerEditorModeCommands>
{
public:
	FGridPlacerEditorModeCommands();
	...
	TSharedPtr<FUICommandInfo> PlacementTool;
